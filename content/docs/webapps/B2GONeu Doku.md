---
title: B2GO Neu Handbuch
description: B2GO Neu Handbuch V1
---
...
In der Schaltfläche „Meine Belege“ finden sich alle Belege die dem mobilen User zugeordnet wurden.
...
Die Belegliste können folgende Parametern gefiltert werden:
...
Standardmäßig gibt es 3 Belegstati:
...
Der Belegkopf zeigt in folgende Informationen in Gruppen unterteilt

Die Gruppen, sowie die Gruppenfelder können ebenfalls in den Metadaten angepasst werden
...
•	Menge mit Verkaufsmengeneinheit

•	Einzelpreis mit Währung abzüglich Rabatt
...
In Belegfuss werden folgende Informationen angezeigt:

•	Rabatt

•	Zuschläge

#### 1.4	Belegerstellung / Bearbeiten

Ein Beleg kann in den Verkaufsbelegen über die zur Verfügung gestellten Beleganlage Buttons für die jeweilige Beleg-Art gestartet werden.

Es ist ebenfalls möglich einen Beleg aus der Belegliste mit folgenden Button zu starten. Siehe Bild 3.2.
...
Die Belegerstellung hat 5 Stufen:
...
Das Navigieren zwischen den Stufen im Beleg funktioniert über die Buttons Next und Previous, sowie das Tippen auf die eine Stufe Fortschrittsleiste.
...
#### 1.5.1	Positionssuche

In der Positionssuche könne Sie nach den folgenden Parametern gesucht werden:
...
#### 1.5.2	Positionsdetails

In den Positionsdetails können die Menge sowie der Rabatt vergeben werden.
...
Wenn gewünscht kann mit der Schaltfläche „SIGNATUR HINZUFÜGEN“

die Unterschrift eingegeben werden.

Wenn Sie die Unterschrift vergeben ist der Name verpflichtend.
